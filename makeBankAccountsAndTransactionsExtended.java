		...
		try
		{
			...
			for( int i = 0; i < inputLines.size(); )
			{
				...
				if( inn.startsWith("new BankAccount") )
				{
					...
					vural_BankAccount ba = new vural_BankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
				...
				if( inn.startsWith("new EnhancedBankAccount") )
				{
					...
					double checkingInitialValue = Double.parseDouble(st.nextToken());
					double savingsInitialValue = Double.parseDouble(st.nextToken());
					vural_EnhancedBankAccount eba = new vural_EnhancedBankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
					...
					while( true )
					{
						...
						if( type.equals("getWithdrawFromChecking") )
						{
							...
							for( Transaction e : transactions )
							{
								String aStr = e.toString();
								if ( aStr.startsWith("withdrawFromChecking")){
								System.out.println("\t" + e);
								}
							}
						}
						...
						if( type.equals("getWithdrawFromSavings") )
						{
							...
							{
								String aStr = e.toString();
								if ( aStr.startsWith("withdrawFromSavings")){
								System.out.println("\t" + e);
								}
							}
						}
						...
						if( type.equals("getDepositToChecking") )
						{
							...
							{
								String aStr = e.toString();
								if ( aStr.startsWith("depositToChecking")){
								System.out.println("\t" + e);
								}
							}
						}
						...
						if( type.equals("getDepositToSavings") )
						{
							...
							{
								String aStr = e.toString();
								if ( aStr.startsWith("depositToSavings")){
								System.out.println("\t" + e);
								}
							}
						}
						...
						if( type.equals("getTransferToChecking") )
						{
							...
							{
								String aStr = e.toString();
								if ( aStr.startsWith("transferFromSavingsToChecking")){
								System.out.println("\t" + e);
								}
							}
						}
						...
						if( type.equals("getTransferToSavings") )
						{
							...
							{
								String aStr = e.toString();
								if ( aStr.startsWith("transferFromCheckingToSavings")){
								System.out.println("\t" + e);
								}
							}
						}
